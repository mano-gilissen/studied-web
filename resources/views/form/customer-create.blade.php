...
@section('fields')
    ...
    @include('component.field-input', ['id' => 'category', 'tag' => __('Categorie'), 'placeholder' => __('Welk soort klant is deze persoon?'), 'icon' => 'dropdown.svg', 'required' => true, 'data' => true, 'show_all' => true, 'reject_others' => true, 'show_always' => true, 'uses_id' => true, 'value' => old('category')])
