...
@section('fields')
    ...
    @include('component.field-select-time', ['set_start' => $study->getReports[0]->start, 'set_end' => $study->getReports[0]->end, 'trigger' => 'report'])
...
@section('actions')
    ...
    <div class="button red" onclick="if(confirm(translated('Weet je zeker dat je dit rapport en de bijhorende les wilt verwijderen? Dit kan niet ongedaan worden gemaakt.'))) { navigate('{{ route('study.delete', [\App\Http\Support\Model::$BASE_KEY => $study->key]) }}'); }">
