            ...
            <div id="actions">
                ...
                @if(\App\Http\Traits\BaseTrait::hasManagementRights())
                    ...
                    @else
                        ...
                        @include('section.contact-popout', ['tag' => __('Contacteer'), 'user' => $person->getUser])
                    ...
                    <div class="column right">
                        ...
                        @switch($person->getUser->role)
                            ...
                            @case(\App\Http\Traits\RoleTrait::$ID_EMPLOYEE)
                                ...
                                @include('section.profile-students-of-employee')

                                @break

                            @case(\App\Http\Traits\RoleTrait::$ID_STUDENT)

                                @include('section.profile-connections')

                                @break

                            @case(\App\Http\Traits\RoleTrait::$ID_CUSTOMER)

                                @include('section.profile-students-of-customer')
                    ...
                    @switch($person->getUser->role)
                        ...
                        @case(\App\Http\Traits\RoleTrait::$ID_MANAGEMENT)
                            ...
                            @if(\App\Http\Traits\BaseTrait::hasManagementRights())
                                ...
                                @include('section.profile-agreements')
                        ...
                        @case(\App\Http\Traits\RoleTrait::$ID_STUDENT)
                            ...
                            @if(\App\Http\Traits\BaseTrait::hasEmployeeRights() || $person->getUser->id == Auth::user()->id || (Auth::user()->role == \App\Http\Traits\RoleTrait::$ID_CUSTOMER && Auth::user()->getCustomer->isStudent($person->getUser->getStudent)))
                                ...
                                @include('section.profile-evaluations')
                    ...
                    <div class="column left">
                        ...
                        @switch(\App\Http\Traits\BaseTrait::getUserRole())
                            ...
                            @case(\App\Http\Traits\RoleTrait::$ID_MANAGEMENT)
                                ...
                                @include('section.profile-contact-personal')
                        ...
                        @switch($person->getUser->role)
                            ...
                            @case(\App\Http\Traits\RoleTrait::$ID_STUDENT)
                                ...
                                @if(\App\Http\Traits\BaseTrait::hasManagementRights())
                                    ...
                                    @include('section.profile-organisatie')
                        ...
                        @switch($person->getUser->role)
                            ...
                            @case(\App\Http\Traits\RoleTrait::$ID_BOARD)
                                ...
                                @if(\App\Http\Traits\BaseTrait::hasBoardRights())
                                    ...
                                    @include('section.profile-dienstbetrekking')
                            ...
                            @if(!$customer || $customer->getUser->{\App\Http\Support\Model::$USER_CATEGORY} == \App\Http\Traits\RoleTrait::$CATEGORY_CUSTOMER_PARENT)
                                ...
                                @switch(\App\Http\Traits\BaseTrait::getUserRole())
                                    ...
                                    @case(\App\Http\Traits\RoleTrait::$ID_MANAGEMENT)
                                        ...
                                        @include('section.profile-education')

                                        @include('section.profile-education-relations')
                        ...
                        @switch($person->getUser->role)
                            ...
                            @case(\App\Http\Traits\RoleTrait::$ID_BOARD)
                                ...
                                @if(\App\Http\Traits\BaseTrait::hasBoardRights())
                                    ...
                                    @include('section.profile-loopbaan')
