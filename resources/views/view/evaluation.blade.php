            ...
            <div id="content">
                        ...
                        <div class="block-users">
                            ...
                            <div class="list-users">
                                ...
                                @if($evaluation->getStudent->getStudent->getCustomer)
                                    ...
                                    @include('component.person', ['person' => $evaluation->getStudent->getStudent->getCustomer->getUser->getPerson, 'subtitle' => __('Ouder/verzorger')])
                ...
                @if($evaluation->performed)
                    ...
                    <div class="column wide">
                        ...
                        @include('section.evaluation-questions')

                        @include('section.evaluation-agreements')
                ...
                <div class="content-columns">
                    ...
                    <div class="column left">
                        ...
                        @include('section.evaluation-details')

                    </div>

                    <div class="column right">

                        @include('section.evaluation-location')
