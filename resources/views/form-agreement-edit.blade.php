...
@section('fields')
    ...
    @include('form.field-input', ['id' => 'preference_group', 'tag' => __('Voorkeur groepsles of individueel'), 'required' => true, 'data' => true, 'reject_other' => true, 'show_all' => true, 'show_always' => true, 'ac_data' => 'preference_group', 'uses_id' => true, 'set_id' => $agreement->{\App\Http\Support\Model::$AGREEMENT_PREFERENCE_GROUP}])

    @include('form.field-input', ['id' => 'preference_location', 'tag' => __('Voorkeur locatie fysiek of digitaal'), 'required' => true, 'data' => true, 'reject_other' => true, 'show_all' => true, 'show_always' => true, 'ac_data' => 'preference_location', 'uses_id' => true, 'set_id' => $agreement->{\App\Http\Support\Model::$AGREEMENT_PREFERENCE_LOCATION}])
