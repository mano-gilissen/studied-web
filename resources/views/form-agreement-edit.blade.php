...
@section('fields')
    ...
    @include('form.field-input', ['id' => 'student', 'tag' => __('Leerling'), 'icon' => 'lock2.svg','locked' => true, 'value' => \App\Http\Traits\PersonTrait::getFullName(($agreement->getStudent->getPerson))])

    @include('form.field-input', ['id' => 'employee', 'tag' => __('Student-docent'), 'icon' => 'lock2.svg', 'locked' => true, 'value' => \App\Http\Traits\PersonTrait::getFullName(($agreement->getEmployee->getPerson))])

    @include('form.field-input', ['id' => 'service', 'tag' => __('Dienst'), 'icon' => 'lock2.svg', 'locked' => true, 'value' => $agreement->getService->{\App\Http\Support\Model::$SERVICE_NAME}])

    @include('form.field-input', ['id' => 'plan', 'tag' => __('Begeleidingsvorm'), 'icon' => 'lock2.svg', 'locked' => true, 'value' => \App\Http\Traits\AgreementTrait::getPlanText($agreement->{\App\Http\Support\Model::$AGREEMENT_PLAN})])
