    ...
    <tr>
        <td style="padding: 0 0 35px 0;">
            ...
            @if(\App\Http\Traits\StudyTrait::hasLink($study))
                <p style="margin: 0; font-size: 13px; line-height: 22.8px;">
                    {!! __(':full_name heeft een les :subject_name met jou en :participants_text ingepland op :date van :time. De link hiervoor is <a href=":link">:link</a>. Kom op tijd en zorg ervoor dat de leerling(en) weet wat hij moet meenemen en voorbereiden.', [
