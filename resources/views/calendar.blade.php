                    ...
                    @for ($i = 0; $i < 28; $i++)
                        ...
                        <div class="calendar-day">
                            ...
                            @foreach(\App\Models\Study::whereDate('start', '=', $date)->where('address', 1)->get() as $study)
                                ...
                                <div class="study" style="grid-column-start:{{ $start }};grid-column-end:{{ $end }};grid-row-start:1" onclick="navigate('{{ route('study.view', ['key' => $study->{\App\Http\Support\Model::$BASE_KEY}]) }}')">
