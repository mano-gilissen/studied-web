...
<html data-wf-page="60d58f1f88eab3b79cf044df" data-wf-site="60ab5c331d3006ab3cefdc9f">
<head>
  <meta charset="utf-8">
  <title>Begeleiding</title>
  <meta content="We bieden verschillende soorten begeleiding voor middelbare scholieren. Afhankelijk van wat de scholier nodig heeft, kan dit variëren van privéles tot colleges." name="description">
  <meta content="Begeleiding" property="og:title">
  <meta content="We bieden verschillende soorten begeleiding voor middelbare scholieren. Afhankelijk van wat de scholier nodig heeft, kan dit variëren van privéles tot colleges." property="og:description">
  <meta content="Begeleiding" property="twitter:title">
  <meta content="We bieden verschillende soorten begeleiding voor middelbare scholieren. Afhankelijk van wat de scholier nodig heeft, kan dit variëren van privéles tot colleges." property="twitter:description">
...
<body class="body">
    ...
    <div class="menu">
      <div class="menu-content">
        <div class="menu-innerwrap">
          ...
          <a data-w-id="4c17008c-8cec-bf04-ab47-0e03fffc8109" href="/begeleiding" aria-current="page" class="menu-linkblock pageleave w--current">Begeleiding</a>
  ...
  <div data-w-id="c2de0dec-576d-a397-908e-154e9d8e3d2e" class="subpage-header mobile100vh">
    ...
    <div class="subpage-inner">
      <p class="inner-subtekst _2em">Begeleiding</p>
      <h1 class="heading _7em">Van privéles tot colleges, wij bieden altijd maatwerk.</h1>
    </div>
  </div>
  <div class="subpage-section top-bottom lessen">
    <div class="lessen-colwrap">
      <div class="lessen-col left">
        <div class="lessen-titlewrap">
          <p class="black-par _w-tag">01</p>
          <h3 class="bk l32">Privéles</h3>
        </div>
        <div class="lessen-info">
          <p class="black-par">Je eigen student-docent begeleidt je gedurende het schooljaar. Hij/zij gaat samen met jou werken aan het behalen van het doel uit het Plan van Aanpak en de vakafspraak. Zo kun je samen de stof doornemen, opgaven maken en vragen bespreken. Als je voor meerdere vakken privéles wilt, kan dat vaak bij dezelfde student-docent.</p>
        </div>
        <div class="price-section">
          <div class="price-block">
            <div class="price-title">
              <p class="black-par price-tag">Aantal lessen</p>
            </div>
            <div class="price-value">
              <p class="black-par price-tag">Prijs per lesuur</p>
            </div>
          </div>
          <div class="price-block">
            <div class="price-title">
              <p class="black-par">1 t/m 3</p>
            </div>
            <div class="price-value">
              <p class="black-par">€ 35,00</p>
            </div>
          </div>
          <div class="price-block">
            <div class="price-title">
              <p class="black-par">4 t/m 7</p>
            </div>
            <div class="price-value">
              <p class="black-par">€ 31,00</p>
            </div>
          </div>
          <div class="price-block">
            <div class="price-title">
              <p class="black-par">8 t/m 11</p>
            </div>
            <div class="price-value">
              <p class="black-par">€ 27,00</p>
            </div>
          </div>
          <div class="price-block">
            <div class="price-title">
              <p class="black-par">12+</p>
            </div>
            <div class="price-value">
              <p class="black-par">€ 23,00</p>
            </div>
          </div>
        </div>
        <a href="#Contact-Section" data-hover="false" class="main-btn w-button">Aanvragen</a>
      </div>
      <div class="lessen-col right"><img src="images/Begeleiding_Priveles.jpg" loading="lazy" sizes="(max-width: 991px) 100vw, (max-width: 1439px) 50vw, (max-width: 1919px) 52vw, 53vw" srcset="images/Begeleiding_Priveles-p-1080.jpeg 1080w, images/Begeleiding_Priveles-p-1600.jpeg 1600w, images/Begeleiding_Priveles.jpg 1920w" data-hover="false" alt="1-op-1 Bijles op de les locatie van Studied Maastricht" class="lessen-image"></div>
    </div>
  </div>
  <div class="subpage-section top-bottom lessen" id="section-groepsles">
    <div class="lessen-colwrap">
      <div class="lessen-col left">
        <div class="lessen-titlewrap">
          <p class="black-par _w-tag">02</p>
          <h3 class="bk l32">Groepsles</h3>
        </div>
        <div class="lessen-info">
          <p class="black-par b2em">Jullie eigen student-docent begeleidt de groep gedurende het schooljaar. Hij/zij gaat samen met de groep werken aan het behalen van het doel uit het Plan van Aanpak en de vakafspraak. Zo kunnen jullie samen de stof doornemen, opgaven maken en vragen bespreken. Als jullie voor meerdere vakken groepsles willen, kan dat vaak bij dezelfde student-docent.</p>
          <p class="warning-tag">Let op:</p>
          <p class="black-par">Groepslessen zijn inhoudelijk hetzelfde als privélessen, maar dan met een groep. Zodoende doen we ook deze alleen op aanvraag.</p>
        </div>
        <div class="price-section">
          <div class="price-block">
            <div class="price-title">
              <p class="black-par price-tag">Aantal groepsleden</p>
            </div>
            <div class="price-value">
              <p class="black-par price-tag">Prijs per leerling per lesuur</p>
            </div>
          </div>
          <div class="price-block">
            <div class="price-title">
              <p class="black-par">2 t/m 3</p>
            </div>
            <div class="price-value">
              <p class="black-par">€ 22,00</p>
            </div>
          </div>
          <div class="price-block">
            <div class="price-title">
              <p class="black-par">4 t/m 5</p>
            </div>
            <div class="price-value">
              <p class="black-par">€ 19,00</p>
            </div>
          </div>
          <div class="price-block">
            <div class="price-title">
              <p class="black-par">6</p>
            </div>
            <div class="price-value">
              <p class="black-par">€ 16,00</p>
            </div>
          </div>
        </div>
        <a href="#Contact-Section" data-hover="false" class="main-btn w-button">Aanvragen</a>
      </div>
      <div class="lessen-col right"><img src="images/Begeleiding_Groepsles.jpg" loading="lazy" sizes="(max-width: 991px) 100vw, (max-width: 1439px) 50vw, (max-width: 1919px) 52vw, 53vw" srcset="images/Begeleiding_Groepsles-p-500.jpeg 500w, images/Begeleiding_Groepsles-p-1080.jpeg 1080w, images/Begeleiding_Groepsles-p-1600.jpeg 1600w, images/Begeleiding_Groepsles-p-2000.jpeg 2000w, images/Begeleiding_Groepsles.jpg 2301w" data-hover="false" alt="Groepsles bij Studied op de leslocatie in Maastricht" class="lessen-image gl"></div>
    </div>
  </div>
  <div class="subpage-section top-bottom lessen">
    <div class="lessen-colwrap">
      <div class="lessen-col left">
        <div class="lessen-titlewrap">
          <p class="black-par _w-tag">03</p>
          <h3 class="bk l32">Colleges</h3>
        </div>
        <div class="lessen-info last">
          <p class="black-par lessen-par">Colleges zijn gericht op de theorie. In een college worden de basistheorie, basistoepassing en basisinzichten van een vak behandeld. Hiervoor krijgen de deelnemers ons vakhandboek met daarin een kernachtig overzicht van de examenstof met tips en examenopgaven + de slides van de/het college(s) waaraan wordt deelgenomen.</p>
          <p class="black-par lessen-par">We bieden met name colleges voor de examenkids. Zo zijn de colleges van de examenvakken gedurende het hele schooljaar beschikbaar.</p>
          <p class="black-par b2em">Colleges zijn beschikbaar voor het publiek; je hoeft geen begeleiding bij ons te volgen om deel te nemen. Je kunt het programma checken en je inschrijven via de onderstaande knop!</p>
          <p class="warning-tag">Tarieven</p>
          <p class="black-par">€ 20,00 per college, tenzij anders bepaald.</p>
        </div>
        <a href="documents/Programma_Trainingen_Colleges.pdf" data-hover="false" class="main-btn w-button">Programma</a>
      </div>
      <div class="lessen-col right"><img src="images/Begeleiding_Colleges.jpg" loading="lazy" sizes="(max-width: 991px) 100vw, (max-width: 1439px) 50vw, (max-width: 1919px) 52vw, 53vw" srcset="images/Begeleiding_Colleges-p-1080.jpeg 1080w, images/Begeleiding_Colleges-p-1600.jpeg 1600w, images/Begeleiding_Colleges-p-2000.jpeg 2000w, images/Begeleiding_Colleges.jpg 2300w" data-hover="false" alt="Een college over natuurkunde bij Studied in Maastricht" class="lessen-image c"></div>
    </div>
  </div>
  <div class="subpage-section top-bottom lessen">
    <div class="lessen-colwrap">
      <div class="lessen-col left">
        <div class="lessen-titlewrap">
          <p class="black-par _w-tag">04</p>
          <h3 class="bk l32">Trainingen</h3>
        </div>
        <div class="lessen-info last">
          <p class="black-par lessen-par">Trainingen zijn gericht op de praktijk. Een training focust op het succesvol toepassen van de stof ten behoeve van het maken van opgaven en toetsen. Net zoals bij een college krijgen de deelnemers ons vakhandboek met daarin een kernachtig overzicht van de examenstof met tips en examenopgaven + de slides van de training(en) waaraan wordt deelgenomen.</p>
          <p class="black-par lessen-par">We bieden met name trainingen voor de examenkids. Zo zijn er gedurende het hele schooljaar trainingen over de examenstof, plannen, faalangst, concentratie en motivatie.</p>
          <p class="black-par b2em">Trainingen zijn beschikbaar voor het publiek; je hoeft geen begeleiding bij ons te volgen om deel te nemen. Je kunt het programma checken en je inschrijven via de onderstaande knop!</p>
          <p class="warning-tag">Tarieven</p>
          <p class="black-par">€ 20,00 per training, tenzij anders bepaald.</p>
        </div>
          <a href="documents/Programma_Trainingen_Colleges.pdf" data-hover="false" class="main-btn w-button">Programma</a>
      </div>
      <div class="lessen-col right"><img src="images/Begeleiding_Training.jpg" loading="lazy" sizes="(max-width: 991px) 100vw, (max-width: 1439px) 50vw, (max-width: 1919px) 52vw, 53vw" srcset="images/Begeleiding_Training-p-500.jpeg 500w, images/Begeleiding_Training-p-800.jpeg 800w, images/Begeleiding_Training-p-1080.jpeg 1080w, images/Begeleiding_Training-p-1600.jpeg 1600w, images/Begeleiding_Training-p-2000.jpeg 2000w, images/Begeleiding_Training.jpg 2300w" data-hover="false" alt="1-op-1 examentraining" class="lessen-image"></div>
    </div>
  </div>
  <div class="download-container">
    <div class="download-section">
      <h4 class="mw50">Download onze brochure voor meer informatie over ons aanbod.</h4>
      <a href="documents/Studied_brochure_2021.pdf" target="_blank" class="download-button w-inline-block"><img src="images/Download.svg" loading="lazy" data-hover="false" alt="Download knop met het aanbod in een pdf" class="download-arrow"></a>
    </div>
  </div>
  <div class="subpage-section top-bottom bk testimonials">
    <div class="t-wrap">
      ...
      <div data-duration-in="400" data-duration-out="400" data-hover="false" class="tabs w-tabs">
        <div class="t-tabs_menu w-tab-menu">
          <a data-w-tab="Ouders" data-hover="false" class="l-tabhead bk w-inline-block w-tab-link">
            <div class="tab-text">Ouders</div>
          </a>
          <a data-w-tab="BIjleskids" data-hover="false" class="l-tabhead bk w-inline-block w-tab-link w--current">
            <div class="tab-text">Bijleskids</div>
          </a>
          <a data-w-tab="Student-docenten" data-hover="false" class="l-tabhead bk w-inline-block w-tab-link">
            <div class="tab-text">Student-docenten</div>
          </a>
          <a data-w-tab="Partners" data-hover="false" class="l-tabhead bk w-inline-block w-tab-link">
            <div class="tab-text">Partners</div>
          </a>
        </div>
        <div class="tabs-content w-tab-content">
          <div data-w-tab="Ouders" data-hover="false" class="testimonials-tab w-tab-pane">
            <div data-animation="slide" data-disable-swipe="1" data-duration="500" data-hover="false" class="t-slider w-slider">
              ...
              <div class="right-arrow dpn w-slider-arrow-right">
                <p class="swipe">Bekijk meer</p><img src="images/WhiteArrow.svg" loading="lazy" data-hover="false" alt="">
              </div>
              <div class="slide-nav w-slider-nav w-round"></div>
            </div>
            <div data-animation="slide" data-disable-swipe="1" data-duration="500" data-hover="false" class="t-slider mobile w-slider">
              <div class="t-slidermask w-slider-mask">
                <div class="slide w-slide">
          ...
          <div data-w-tab="BIjleskids" data-hover="false" class="testimonials-tab w-tab-pane w--tab-active">
            <div data-animation="slide" data-disable-swipe="1" data-duration="500" data-hover="false" class="t-slider w-slider">
              <div class="t-slidermask w-slider-mask">
                <div class="slide w-slide">
                  <div class="t-tabwrap">
          ...
          <div data-w-tab="Student-docenten" data-hover="false" class="testimonials-tab w-tab-pane">
            <div data-animation="slide" data-disable-swipe="1" data-duration="500" data-hover="false" class="t-slider w-slider">
              <div class="t-slidermask w-slider-mask">
                <div class="slide w-slide">
                  <div class="t-tabwrap">
          ...
          <div data-w-tab="Partners" data-hover="false" class="testimonials-tab w-tab-pane">
            <div data-animation="slide" data-disable-swipe="1" data-duration="500" data-hover="false" class="t-slider w-slider">
              <div class="t-slidermask w-slider-mask">
                <div class="slide w-slide">
                  <div class="t-tabwrap">
  ...
  <div id="Contact-Section" data-hover="false" class="subpage-section contactform">
    <div class="cf-container">
      <div class="cf-header">
        <h3 class="b2 bk">Nog vragen?</h3>
        <p class="cf-par bk">Nog vragen over de begeleiding? Stuur ons een bericht en dan nemen we direct contact op!</p>
      </div>
      <div class="form-wrapper w-form">
          ...
          <div class="cf-selectcontainer">
            ...
            <div class="cf-innerwrap"><label class="w-checkbox cf-select">
                <div class="w-checkbox-input w-checkbox-input--inputType-custom cf-select__btn"></div><input type="checkbox" id="Priveles" name="Priveles" data-name="Priveles" data-hover="false" style="opacity:0;position:absolute;z-index:-1"><span for="Priveles" data-hover="false" class="cf-select__text w-form-label">Privéles</span>
              </label><label class="w-checkbox cf-select">
                <div class="w-checkbox-input w-checkbox-input--inputType-custom cf-select__btn"></div><input type="checkbox" id="Groepsles" name="Groepsles" data-name="Groepsles" data-hover="false" style="opacity:0;position:absolute;z-index:-1"><span for="Groepsles" data-hover="false" class="cf-select__text w-form-label">Groepsles</span>
              </label></div>
            <div class="cf-innerwrap"><label class="w-checkbox cf-select">
                <div class="w-checkbox-input w-checkbox-input--inputType-custom cf-select__btn"></div><input type="checkbox" id="Colleges" name="Colleges" data-name="Colleges" data-hover="false" style="opacity:0;position:absolute;z-index:-1"><span for="Colleges" data-hover="false" class="cf-select__text w-form-label">Colleges</span>
              </label><label class="w-checkbox cf-select">
                <div class="w-checkbox-input w-checkbox-input--inputType-custom cf-select__btn"></div><input type="checkbox" id="Trainingen" name="Trainingen" data-name="Trainingen" data-hover="false" style="opacity:0;position:absolute;z-index:-1"><span for="Trainingen" data-hover="false" class="cf-select__text w-form-label">Trainingen</span>
              </label></div>
          </div>
          <div class="cf-main">
            <div class="cf-title">
            ...
            <div class="cf-colwrap">
              <div class="cf-column left"><label for="Voornaam-2" data-hover="false" class="cf-fieldlabel">Voornaam</label><input type="text" class="cf-textfield w-input" autocomplete="off" maxlength="256" name="Voornaam-2" data-name="Voornaam 2" placeholder="Jouw voornaam" data-hover="false" id="Voornaam-2" required=""></div>
              <div class="cf-column right"><label for="Achternaam-2" data-hover="false" class="cf-fieldlabel">Achternaam</label><input type="text" class="cf-textfield w-input" autocomplete="off" maxlength="256" name="Achternaam-2" data-name="Achternaam 2" placeholder="Jouw Achternaam" data-hover="false" id="Achternaam-2"></div>
            </div>
            <div class="cf-colwrap">
              <div class="cf-column left"><label for="Email-2" data-hover="false" class="cf-fieldlabel">Email</label><input type="email" class="cf-textfield w-input" autocomplete="off" maxlength="256" name="Email-2" data-name="Email 2" placeholder="Jouw email adres" data-hover="false" id="Email-2" required=""></div>
              <div class="cf-column right"><label for="Telefoon-2" data-hover="false" class="cf-fieldlabel">Telefoonnummer</label><input type="tel" class="cf-textfield w-input" autocomplete="off" maxlength="256" name="Telefoon-2" data-name="Telefoon 2" placeholder="Jouw telefoonnummer" data-hover="false" id="Telefoon-2"></div>
            </div>
            <div class="cf-colwrap">
              <div class="cf-column left"><label for="email-3" data-hover="false" class="cf-fieldlabel">Stad</label><select id="field-3" name="field-3" data-name="Field 3" required="" data-hover="false" class="w-select">
    ...
    <div class="footer-innerwrap">
      ...
      <div class="footer-col">
        ...
        <div class="footer-innercol">
          ...
          <div class="footer-linkwrap">
            <a href="{{ route('begeleiding') }}" aria-current="page" class="footer-link w--current">Begeleiding</a>
          </div>
          <div class="footer-linkwrap">
            <a href="{{ route('werkwijze') }}" class="footer-link">Werkwijze</a>
          </div>
          <div class="footer-linkwrap">
            <a href="{{ route('werk') }}" class="footer-link">Werk</a>
          </div>
          <div class="footer-linkwrap">
            <a href="{{ route('zakelijk') }}" class="footer-link">Zakelijk</a>
          </div>
        </div>
      </div>
        ...
        <div class="footer-row">
          ...
          <div class="footer-innercol">
            <div class="footer-formblock w-form">
                <form action="https://submit-form.com/Z4XCkyvu" id="wf-form-Newsletter" data-name="Newsletter" data-hover="false" class="footer-form"><input type="email" class="footer-textfield w-input" autocomplete="off" maxlength="256" name="Nieuwsbrief-Email" data-name="Nieuwsbrief Email" placeholder="Jouw email adres" data-hover="false" id="Nieuwsbrief-Email" required=""><input type="submit" value="Inschrijven" data-wait="Even geduld..." data-hover="false" class="cf-submit footer w-button"><!--  name="wf-form-Newsletter" -->
