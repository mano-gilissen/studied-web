...
<html data-wf-page="60d5aa0c052d0ff6b19a58cf" data-wf-site="60ab5c331d3006ab3cefdc9f">
<head>
  <meta charset="utf-8">
  <title>Article</title>
  ...
  <link href="{{ asset('css/normalize_210525.css') }}" rel="stylesheet" type="text/css">
  <link href="{{ asset('css/webflow.css') }}s" rel="stylesheet" type="text/css">
  <link href="{{ asset('css/studied.webflow_210525.css') }}" rel="stylesheet" type="text/css">
...
<body class="body">
  ...
  <script src="{{ asset('js/webflow_210525.js') }}" type="text/javascript"></script>
