...
<head>
  ...
  <link href="{{ asset('css/normalize_100823.css') }}" rel="stylesheet" type="text/css">
  <link href="{{ asset('css/webflow.css') }}s" rel="stylesheet" type="text/css">
  <link href="{{ asset('css/studied.webflow_100823.css') }}" rel="stylesheet" type="text/css">
...
<body class="body">
  ...
  <script src="{{ asset('js/webflow_100823.js') }}" type="text/javascript"></script>
