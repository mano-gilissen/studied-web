...
<html data-wf-page="60cc566e1207846f4b2da243" data-wf-site="60ab5c331d3006ab3cefdc9f">
<head>
  <meta charset="utf-8">
  <title>Werk</title>
  <meta content="Persoonlijke begeleiding is meer dan les geven. Begeleid onze scholieren als student-docent of sluit je aan bij ons hoofdkantoor!" name="description">
  <meta content="Werk" property="og:title">
  <meta content="Persoonlijke begeleiding is meer dan les geven. Begeleid onze scholieren als student-docent of sluit je aan bij ons hoofdkantoor!" property="og:description">
  <meta content="Werk" property="twitter:title">
  <meta content="Persoonlijke begeleiding is meer dan les geven. Begeleid onze scholieren als student-docent of sluit je aan bij ons hoofdkantoor!" property="twitter:description">
...
<body class="body">
    ...
    <div class="menu">
      <div class="menu-content">
        <div class="menu-innerwrap">
          ...
          <a data-w-id="4c17008c-8cec-bf04-ab47-0e03fffc810f" href="/werk" aria-current="page" class="menu-linkblock pageleave w--current">Werk</a>
  ...
  <div data-w-id="8082bd85-f4b3-ba40-c2f7-db0fd8c0f2b3" class="subpage-header mobile100vh">
    ...
    <div class="subpage-inner">
      <p class="inner-subtekst _2em">Werk</p>
      <h1 class="heading _7em">Persoonlijke begeleiding is meer dan les geven.</h1>
    </div>
  </div>
  <div class="subpage-section top-bottom jobs">
    <div class="jobs-col left desktop">
      <div class="jobs-secondinfo">
        <div class="zakelijk-titlewrap">
          <p class="black-par _w-tag">01</p>
          <h5 class="bk l32">Student-docent</h5>
        </div>
        <div class="_w-info">
          <p class="black-par b2em b0">Onze student-docenten begeleiden bijleskids bij alle vakken op alle niveaus. Vakinhoudelijke kennis en empathisch vermogen is wat onze student-docenten kenmerkt.</p>
          <p class="black-par tag">Vereisten</p>
          <div class="list-item last">
            <div class="bullet bk"></div>
            <p class="listitem-text bk">Onze student-docenten hebben minimaal vwo afgerond.</p>
          </div>
          <p class="black-par tag">Vacatures</p>
          <div class="list-item last">
            <div class="bullet bk"></div>
            <p class="listitem-text bk">Wij zijn altijd op zoek naar student-docenten die ons team versterken!</p>
          </div>
        </div>
      </div>
      <a href="#Contact-Section" class="main-btn w-button">Solliciteer nu</a>
    </div>
    <div class="jobs-col desktop">
      <div class="jobs-maininfo">
        <h6 class="werk-subheader">Werkzaamheden</h6>
        <p class="black-par bigpar">Het student-docentschap is geen baan, maar een verantwoordelijkheid. Jij begeleidt onze bijleskids zodat ze hun doel bereiken. Dat betekent dat je ze niet alleen les geeft, maar ook met ze plant en ze motiveert. Je bevindingen communiceer en rapporteer je naar de managing-student en ouders, zodat samen gekeken kan worden wat het beste werkt! Je staat er dus nooit alleen voor.</p>
      </div>
      <div class="scholen-imagewrap"><img src="images/Werk_Student-Docent.jpg" loading="lazy" sizes="(max-width: 991px) 100vw, (max-width: 1439px) 56vw, (max-width: 1919px) 67vw, 68vw" srcset="images/Werk_Student-Docent-p-500.jpeg 500w, images/Werk_Student-Docent.jpg 2301w" alt="Sfeerbeeld van de individuele bijles als student-docent" class="image"></div>
    </div>
    <div class="jobs-col left phone">
      <div class="jobs-secondinfo">
        <div class="zakelijk-titlewrap">
          <p class="black-par _w-tag">01</p>
          <h5 class="bk l32">Student-docent</h5>
        ...
        <div class="_w-info">
          <p class="black-par b2em">Onze student-docenten begeleiden bijleskids bij alle vakken op alle niveaus. Vakinhoudelijke kennis en empathisch vermogen is wat onze student-docenten kenmerkt.</p>
        </div>
        <div class="scholen-imagewrap"><img src="images/Werk_Student-Docent.jpg" loading="lazy" sizes="(max-width: 479px) 92vw, (max-width: 767px) 95vw, (max-width: 991px) 85vw, 100vw" srcset="images/Werk_Student-Docent-p-500.jpeg 500w, images/Werk_Student-Docent.jpg 2301w" alt="Sfeerbeeld van de individuele bijles als student-docent" class="image"></div>
      </div>
    </div>
    <div class="jobs-col phone">
      <div class="jobs-maininfo">
        <h6 class="werk-subheader">Werkzaamheden</h6>
        <p class="black-par bigpar">Het student-docentschap is geen baan, maar een verantwoordelijkheid. Jij begeleidt onze bijleskids zodat ze hun doel bereiken. Dat betekent dat je ze niet alleen les geeft, maar ook met ze plant en ze motiveert. Je bevindingen communiceer en rapporteer je naar de managing-student en ouders, zodat samen gekeken kan worden wat het beste werkt! Je staat er dus nooit alleen voor.</p>
      </div>
      ...
      <a href="#Contact-Section" class="main-btn jobs-btn w-button">Solliciteer nu</a>
    </div>
  </div>
  <div class="subpage-section top-bottom jobs">
    <div class="jobs-col left desktop">
      <div class="jobs-secondinfo">
        <div class="zakelijk-titlewrap">
          ...
          <h5 class="bk l32">Managing-student</h5>
        </div>
        <div class="_w-info">
          <p class="black-par b2em b0">De managing-student geeft leiding aan de locatie. Dit is het aanspreekpunt voor ouders, bijleskids en student-docenten van de locatie.</p>
          <p class="black-par tag">Vereisten</p>
          <div class="list-item werk-listitem">
            <div class="bullet bk"></div>
            <p class="listitem-text bk">Je hebt minimaal een jaar leservaring binnen de organisatie, hierop wordt slechts een uitzondering gemaakt in specifieke gevallen.</p>
          </div>
          <div class="list-item last">
            <div class="bullet bk"></div>
            <p class="listitem-text bk">Je rondt de interne-opleiding succesvol af.</p>
          </div>
          <p class="black-par tag">Vacatures</p>
          <div class="list-item last">
            <div class="bullet bk"></div>
            <p class="listitem-text bk">Managing-students worden intern geselecteerd en opgeleid.</p>
          </div>
        </div>
      </div>
      <a href="#" class="main-btn w-button">Solliciteer nu</a>
    </div>
    <div class="jobs-col desktop">
      <div class="jobs-maininfo">
        <h6 class="werk-subheader">Werkzaamheden</h6>
        <p class="black-par bigpar">Ze behandelen aanvragen, leiden kennismakingsgesprekken en onderhouden klantcontact. Ook behandelt de managing-student de sollicitatie en leidt hij/zij het team. Verder, ondersteunen ze het hoofdkantoor door bijvoorbeeld lesrapporten te checken en contact te houden met scholen.</p>
      </div>
      <div class="scholen-imagewrap"><img src="images/Werk_Managing-Student.jpg" loading="lazy" sizes="(max-width: 991px) 100vw, (max-width: 1439px) 56vw, (max-width: 1919px) 67vw, 68vw" srcset="images/Werk_Managing-Student-p-500.jpeg 500w, images/Werk_Managing-Student.jpg 2300w" alt="Een meeting van het managementteam op kantoor" class="image"></div>
    </div>
    <div class="jobs-col left phone">
      <div class="jobs-secondinfo">
        <div class="zakelijk-titlewrap">
        ...
        <div class="_w-info">
          <p class="black-par b2em">De managing-student geeft leiding aan de locatie. Dit is het aanspreekpunt voor ouders, bijleskids en student-docenten van de locatie.</p>
        </div>
        <div class="scholen-imagewrap"><img src="images/Werk_Managing-Student.jpg" loading="lazy" sizes="(max-width: 479px) 92vw, (max-width: 767px) 95vw, (max-width: 991px) 85vw, 100vw" srcset="images/Werk_Managing-Student-p-500.jpeg 500w, images/Werk_Managing-Student.jpg 2300w" alt="Een meeting van het managementteam op kantoor" class="image"></div>
      </div>
    </div>
    <div class="jobs-col phone">
      <div class="jobs-maininfo">
  ...
  <div class="subpage-section top-bottom jobs">
    <div class="jobs-col left desktop">
      <div class="jobs-secondinfo">
        <div class="zakelijk-titlewrap">
          ...
          <h5 class="bk l32">Hoofdkantoor</h5>
        </div>
        <div class="_w-info">
          <p class="black-par b2em b0">Ons hoofdkantoor zorgt ervoor dat alle werkzaamheden en ontwikkelingen van de organisatie soepel verlopen. Dit is het aanspreekpunt voor medewerkers en externe-relaties.</p>
          <p class="black-par tag">Vereisten</p>
          <div class="list-item last">
            <div class="bullet bk"></div>
            <p class="listitem-text bk">Afhankelijk van de functie.</p>
          </div>
          <p class="black-par tag">Vacatures</p>
          <div class="list-item last">
            <p class="listitem-text bk">Op aanvraag</p>
          </div>
        </div>
      </div>
      <a href="#Contact-Section" class="main-btn w-button">Solliciteer nu</a>
    ...
    <div class="jobs-col desktop">
      <div class="jobs-maininfo">
        <h6 class="werk-subheader">Werkzaamheden</h6>
        <p class="black-par bigpar">Het hoofdkantoor ondersteunt de werkzaamheden van onze vestigingen, zo is het verantwoordelijk voor de administratie, IT en HR. Daarnaast is dit de centrale plaats voor marketing en communicatie, PR, brand-management en business development. Vanuit het hoofdkantoor worden nieuwe concepten ontwikkeld en geïmplementeerd voor de organisatie.</p>
      </div>
      <div class="scholen-imagewrap"><img src="images/Werk_Hoofdkantoor.jpg" loading="lazy" sizes="(max-width: 991px) 100vw, (max-width: 1439px) 56vw, (max-width: 1919px) 67vw, 68vw" srcset="images/Werk_Hoofdkantoor-p-500.jpeg 500w, images/Werk_Hoofdkantoor.jpg 1531w" alt="Buitenaanzicht van Studied headquarters" class="image office"></div>
    </div>
    <div class="jobs-col left phone">
      <div class="jobs-secondinfo">
        <div class="zakelijk-titlewrap">
        ...
        <div class="_w-info">
          <p class="black-par b2em">Ons hoofdkantoor zorgt ervoor dat alle werkzaamheden en ontwikkelingen van de organisatie soepel verlopen. Dit is het aanspreekpunt voor medewerkers en externe-relaties.</p>
        </div>
        <div class="scholen-imagewrap"><img src="images/Werk_Hoofdkantoor.jpg" loading="lazy" sizes="(max-width: 479px) 92vw, (max-width: 767px) 95vw, (max-width: 991px) 85vw, 100vw" srcset="images/Werk_Hoofdkantoor-p-500.jpeg 500w, images/Werk_Hoofdkantoor.jpg 1531w" alt="Buitenaanzicht van Studied headquarters" class="image hq"></div>
      </div>
    </div>
    <div class="jobs-col phone">
      <div class="jobs-maininfo">
    ...
    <div class="t-wrap">
      ...
      <div data-duration-in="400" data-duration-out="400" class="tabs w-tabs">
        <div class="t-tabs_menu w-tab-menu">
          ...
          <a data-w-tab="Student-docenten" class="l-tabhead bk w-inline-block w-tab-link w--current">
            <div class="tab-text">Student-docenten</div>
          </a>
          <a data-w-tab="Partners" class="l-tabhead bk w-inline-block w-tab-link">
        ...
        <div class="tabs-content w-tab-content">
          ...
          <div data-w-tab="Student-docenten" class="testimonials-tab w-tab-pane w--tab-active">
            <div data-animation="slide" data-disable-swipe="1" data-duration="500" class="t-slider w-slider">
              <div class="t-slidermask w-slider-mask">
                <div class="slide w-slide">
                  <div class="t-tabwrap">
          ...
          <div data-w-tab="Partners" class="testimonials-tab w-tab-pane">
            <div data-animation="slide" data-disable-swipe="1" data-duration="500" class="t-slider w-slider">
              <div class="t-slidermask w-slider-mask">
                <div class="slide w-slide">
                  <div class="t-tabwrap">
  ...
  <div id="Contact-Section" class="subpage-section contactform">
    <div class="cf-container">
      <div class="cf-header">
        ...
        <p class="cf-par bk">Nog vragen over werken bij Studied? Stuur ons een bericht en dan nemen we direct contact op!</p>
      </div>
        ...
        <form action="https://submit-form.com/xSgds62z" id="email-form" data-name="Email Form" autocomplete="off" class="cf-body"> <!-- name="email-form" -->
          ...
          <div class="cf-selectcontainer">
            ...
            <div class="cf-innerwrap"><label class="w-checkbox cf-select">
                <div class="w-checkbox-input w-checkbox-input--inputType-custom cf-select__btn"></div><input type="checkbox" id="Student Docent" name="Student-Docent" data-name="Student Docent" style="opacity:0;position:absolute;z-index:-1"><span for="Student Docent" class="cf-select__text w-form-label">Student-docent</span>
              </label><label class="w-checkbox cf-select">
                <div class="w-checkbox-input w-checkbox-input--inputType-custom cf-select__btn"></div><input type="checkbox" id="Managing Student" name="Managing-Student" data-name="Managing Student" style="opacity:0;position:absolute;z-index:-1"><span for="Managing Student" class="cf-select__text w-form-label">Managing-student</span>
              </label></div>
            <div class="cf-innerwrap"><label class="w-checkbox cf-select">
                <div class="w-checkbox-input w-checkbox-input--inputType-custom cf-select__btn"></div><input type="checkbox" id="Hoofdkantoor" name="Hoofdkantoor" data-name="Hoofdkantoor" style="opacity:0;position:absolute;z-index:-1"><span for="Hoofdkantoor" class="cf-select__text w-form-label">Hoofdkantoor</span>
              </label><label class="w-checkbox cf-select">
          ...
          <div class="cf-main">
            ...
            </div><label for="Email-2" class="cf-fieldlabel">Email</label><textarea placeholder="Jouw bericht" maxlength="5000" id="field-2" name="field-2" required="" autocomplete="off" class="textarea w-input"></textarea>
              <div class="g-recaptcha" style="margin-bottom:48px" data-sitekey="6Lf_HAMdAAAAAAd_W2EK30A8Yz71TmZxacFIjkbH"></div><input type="submit" value="Versturen" data-wait="Even geduld..." class="cf-submit w-button">
          </div>
        </form>
    ...
    <div class="footer-innerwrap">
      ...
      <div class="footer-col">
        ...
        <div class="footer-innercol">
          ...
          <div class="footer-linkwrap">
            <a href="/werk" aria-current="page" class="footer-link w--current">Werk</a>
          </div>
          <div class="footer-linkwrap">
