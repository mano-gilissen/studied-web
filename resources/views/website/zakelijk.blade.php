    ...
    <div class="menu">
        <div class="menu-content">
            <div class="menu-innerwrap">
                ...
                <a data-w-id="4c17008c-8cec-bf04-ab47-0e03fffc8111" href="zakelijk.html" aria-current="page" class="menu-linkblock pageleave w--current">Zakelijk</a>
    ...
    <div class="footer-innerwrap">
        ...
        <div class="footer-col">
            ...
            <div class="footer-innercol">
                ...
                <div class="footer-linkwrap">
                    <a href="zakelijk.html" aria-current="page" class="footer-link w--current">Zakelijk</a>
                </div>
            </div>
        </div>
