            ...
            <div data-w-tab="Hoofdkantoor" class="l-tab w-tab-pane">
                <div class="tab-container">
                    <div class="tab-column small b3m">
                        <p class="black-par l-par">Het hoofdkantoor is gevestigd in Maastricht aan de Stationsstraat 19 B02. Vanuit hier worden de managing-students aangestuurd.</p>
                        <p class="black-par bold b-25">Maastricht</p>
                        <p class="black-par b-25">Stationsstraat 19 B02</p>
