                ...
                <div class="announcement">
                    ...
                    <div class="author">
                        {!!
                            ...
                            (\App\Http\Traits\BaseTrait::hasManagementRights() ? ('<span style="font-style:italic;opacity:.5">' . __('voor') . '&nbsp;' . \App\Http\Traits\RoleTrait::getName($announcement->role) . '</span>&nbsp;&nbsp;-&nbsp;&nbsp;') : ($announcement->author ? '-&nbsp;&nbsp;' : '')) .
