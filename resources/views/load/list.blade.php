            ...
            <div class="filter" id="filter_{{ $column->id }}">
                ...
                @switch($column->id)
                    ...
                    @case(\App\Http\Controllers\StudyController::$COLUMN_HOST)
                        ...
                        @include('form.box-input', ['id' => 'filter_input_' . $column->id, 'identifier' => $column->id, 'data' => true, 'show_all' => true, 'reject_other' => true, 'uses_id' => true, 'form' => false, 'trigger' => 'filter'])
