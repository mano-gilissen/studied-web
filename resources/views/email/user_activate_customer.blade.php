                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 32px;">De proefles van {{ $student->getPerson->{\App\Http\Support\Model::$PERSON_FIRST_NAME} }} met {{ $study->getHost->getPerson->{\App\Http\Support\Model::$PERSON_FIRST_NAME} }} was een succes! Dat betekent dat {{ $student->getPerson->{\App\Http\Support\Model::$PERSON_FIRST_NAME} }} nu officieel begeleiding bij ons volgt.</p>
