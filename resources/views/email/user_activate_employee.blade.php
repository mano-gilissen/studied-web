                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 32px;">De documenten t.b.v. de indiensttreding zijn verwerkt. Dat betekent dat je nu officieel bij ons team hoort.</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 32px;">Activeer je account in onze web-app. Hiermee krijg je toegang tot de gegevens met betrekking tot je dienstbetrekking. Je wordt hierover op de hoogte gehouden middels automatisch gegenereerde e-mails.</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 32px;">Klik op de onderstaande button om je account te activeren. Mocht je vragen hebben, aarzel dan niet contact op te nemen.</p>
