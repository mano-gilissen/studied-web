                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 32px;">Er is een vakafspraak {{ $agreement->getSubject->{\App\Http\Support\Model::$SUBJECT_NAME} }} voor jou met {{ $student->getPerson->{\App\Http\Support\Model::$PERSON_FIRST_NAME} }} aangemaakt. Als de proefles succesvol is, kun je lessen inplannen met deze vakafspraak.</p>
