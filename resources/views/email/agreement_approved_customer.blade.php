                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 32px;">De vakafspraken zijn definitief. Dat betekent dat er elke maand lessen met {{ $student->getPerson->{\App\Http\Support\Model::$PERSON_FIRST_NAME} }} worden ingepland conform deze afspraken. De vakafspraken gelden voor een bepaalde tijd. Bij het evaluatiegesprek wordt gekeken of deze moeten worden verlengd, gewijzigd of beëindigd. Zo sluit onze begeleiding nog beter aan op de behoefte van de scholier.</p>
