                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 24px;">Beste {{ (strlen($user->getPerson->{\App\Http\Support\Model::$PERSON_PREFIX}) > 0 ? $user->getPerson->{\App\Http\Support\Model::$PERSON_PREFIX} . ' ' : '') . $user->getPerson->{\App\Http\Support\Model::$PERSON_FIRST_NAME} }},</p>
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 32px;">U kunt de begeleiding volgen in onze web-app. Mocht u vragen hebben, aarzel dan niet contact op te nemen.</p>
