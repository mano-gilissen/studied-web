...
@section('fields')
    ...
    @include('form.field-input', ['id' => 'status', 'tag' => 'Status', 'icon' => 'dropdown.svg', 'placeholder' => 'Kies een status', 'required' => true, 'data' => true, 'show_all' => true, 'show_always' => true, 'reject_other' => true, 'uses_id' => true, 'locked' => \App\Http\Traits\StudyTrait::isReported($study), 'set_id' => $study->{\App\Http\Support\Model::$STUDY_STATUS}])
