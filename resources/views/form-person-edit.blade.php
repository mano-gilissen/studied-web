...
@section('fields')
    ...
    @include('form.field-input', ['id' => 'language', 'tag' => __('Taal'), 'icon' => 'dropdown.svg', 'required' => true, 'data' => true, 'show_all' => true, 'reject_others' => true, 'show_always' => true, 'ac_data' => 'language', 'uses_id' => true, 'value' => \App\Http\Middleware\Locale::getOption_text($person->getUser->{\App\Http\Support\Model::$USER_LANGUAGE})])
