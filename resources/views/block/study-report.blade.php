                ...
                @foreach($report->getReport_Subjects as $report_subject)
                    ...
                    <div class="subject">
                        ...
                        <div class="bar-wrap">
                            ...
                            <div class="bar-duration" style="width: {{ ($report_subject->{\App\Http\Support\Model::$REPORT_SUBJECT_DURATION} / \App\Http\Traits\ReportTrait::getDurationTotal($report)) * 104 }}">
