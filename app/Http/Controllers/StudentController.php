...
class StudentController extends Controller {
    ...
    public function list_value($student, $column) {
        ...
        switch ($column->{Table::COLUMN_ID}) {
            ...
            case self::$COLUMN_CUSTOMER:
                ...
                return PersonTrait::getFullName($student->getCustomer->getUser->getPerson);
    ...
    public function list_link($person) {

        return route('person.view', [Model::$BASE_KEY => $person->{Model::$PERSON_SLUG}]);
