...
class Study_Planned_Employee extends Mailable {
    ...
    public function __construct(Study $study) {
        ...
        $this->subject                              = Lang::get('Er is een :service voor je ingepland met :participants', ['service' => __(strtolower($study->getService->{Model::$SERVICE_SHORT})), 'participants' => StudyTrait::getParticipantsText($study)], $this->employee->{Model::$USER_LANGUAGE});
